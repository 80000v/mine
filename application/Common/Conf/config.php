...
$configs= array(
        ...
        'MODULE_ALLOW_LIST'  => array('Admin','Portal','Asset','Api','User','Wx','Comment','Qiushi','Tpl','Topic','Install','Bug','Better','Pay','Cas','Mobile','App'),
	...
	'LOAD_EXT_CONFIG'=>'s_config',
	'upload_pic_dir' => '/data/upload/pic/',//截图上传路径
	'upload_avatar_dir' => '/data/upload/avatar/',//截图上传路径
);
